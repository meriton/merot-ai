            ...
            <div className="pilot-features">
              ...
              <div className="pilot-feature">
                ...
                <div>
                  ...
                  <p>Pay only for what you need, scale when ready</p>
                </div>
              </div>
              <div className="pilot-feature">
                <div className="pilot-icon-wrapper">
                ...
                <div>
                  <strong>Custom guidelines support</strong>
                  <p>We adapt to your taxonomy and labeling standards</p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="clients-grid">
            ...
            <div className="client-card">
              ...
              <h3>Computer Vision Teams</h3>
              <p>Object detection, segmentation, and image classification</p>
            </div>
            <div className="client-card">
              <div className="client-icon-wrapper">
                <svg className="client-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p>Business intelligence and predictive modeling datasets</p>
            </div>
            <div className="client-card">
              <div className="client-icon-wrapper">
                <svg className="client-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p>Sensor fusion, navigation, and environmental perception</p>
            </div>
          </div>
        </div>
      </section>
